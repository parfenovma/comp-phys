...
## 1. Аналитический расчет коэффициентов ряда Фурье
...
### 1.2 Расчет аналитических коэффициентов спектра $p_T(f_n)$
...
### 1.3 Графики функции и аналитического спектра
