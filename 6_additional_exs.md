...
## 1*. Аналитический расчет спектра производной
...
## 2*. Расчет дискретного спектра производной из спектра сигнала
...
## 3*. Расчет спектра производной с использованием БПФ (FFT / IFFT)
